...
void antiDB(){
	...
	for(int o = 0; o < 10; o++){
		int firstElem = execFunctionsGlobalAntiDB((1+o)%2,(2+o)%2,(1+o)%2,(0+o)%2);
		int sndElem = execFunctionsGlobalAntiDB((1+o)%2,(2+o)%2,(1+o)%2,(0+o)%2);
		if(firstElem!=sndElem)
			return;
	}
	//TODO: obfuscate exit to prevent call stack reversing...
	//THis is only a PoC. For production you need to do this more resilient.
 	exit(0);
}
