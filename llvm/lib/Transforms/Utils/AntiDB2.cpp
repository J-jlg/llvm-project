...
#include "llvm/Transforms/Utils/AntiDBHelper2.h"

using namespace llvm;

PreservedAnalyses AntiDB2Pass::run(Function &F, FunctionAnalysisManager &AM) {
  ...
  //TODO: create bogus switch case using IRBuilder to make the analysis more resilient, instead of linked bogus code. This is just a PoC
